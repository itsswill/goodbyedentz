...
<html>
	...
	<head>
		...
		<title>Goodbye Dentz | Professional Dent Removal</title>
		...
		<link rel="stylesheet" type="text/css" href="style/helpers.css"/>
			...
			<div class="template-header-top">
				...
				<div class="template-header-top-logo">
					<a href="index.html" title="">
						...
						<img src="media/image/logo.png" alt="" class="template-logo template-logo-sticky"/>
					</a>
				</div>

				<!-- Menu-->
				<div class="template-header-top-menu template-main bg-custom">
		...
		<div class="template-content">
			...
			<div class="template-section template-section-padding-1 template-clear-fix template-main">
				...
				<div class="template-component-header-subheader">
					<h2>Who Is Goodbye Dentz?</h2>
					<div></div>
					<span>Dent Removal Service</span>
				</div>	
				...
				<div class="template-layout-33x66 template-clear-fix">
					...
					<div class="template-layout-column-left">
						<img src="media/image/sample/460x678/image_01.png" alt=""/>
					</div>
						...
						<div class="template-component-feature-list template-component-feature-list-position-top template-clear-fix">
							...
							<ul class="template-layout-50x50 template-clear-fix">
								...
								<li class="template-layout-column-left template-margin-bottom-reset">
									...
									<h5>The Best bang for your buck!</h5>
									<ul class="template-component-list">
										<li><span class="template-icon-meta-check"></span>We offer multiple cost efficient options</li>
										<li><span class="template-icon-meta-check"></span>We travel to you!</li>
										<li><span class="template-icon-meta-check"></span>Biodegradable and eco-friendly products</li>
										<li><span class="template-icon-meta-check"></span>Trained and skilled crew members</li>
									</ul>
								</li>
			...
			<!-- Section -->
			<div class="template-clear-fix template-main m-t-lg">
				
				<!-- Header + subheader -->
				<div class="template-component-header-subheader">
					<h2>Latest Projects</h2>
					<div></div>
					<span>Dent Repair Gallery</span>
				</div>	
							...
							<div class="template-component-image template-component-image-preloader">
								...
								<a href="media/image/sample/460x678/image_01.jpg" class="template-fancybox" data-fancybox-group="gallery-1">
									...
									<span class="template-component-image-hover">
										<span>
											<span>
												<span class="template-component-image-hover-header">Before</span>
												<span class="template-component-image-hover-divider"></span>
												<span class="template-component-image-hover-subheader">and After</span>
											</span>
										</span>
									</span>
			...
			<div class="template-main">
				...
				<div class="template-footer-top">
					...
					<div class="template-layout-25x25x25x25 template-clear-fix">
						...
						<div class="template-layout-column-left">
							<h6>About</h6>
							<p>Goodbye Dentz is an eco friendly dent removal company. Based out of New York with the knowledge and experience of our professionals, we pride ourselves in the art of dent removing. </p>
							<img src="media/image/logo.png" alt="" class="template-logo" />
						</div>
						...
						<div class="template-layout-column-center-left">
							...
							<ul class="template-list-reset">
								<li><a href="#">Paintfree Dent Repair</a></li>
								<li><a href="#">Hail Damage Repair</a></li>
								<li><a href="#">Bumper Dents</a></li>
								<li><a href="#">Minor Dings</a></li>
							</ul>									
						</div>
				...
				<div class="template-footer-bottom">
					...
					<ul class="template-component-social-icon-list template-component-social-icon-list-2">
						<li><a href="https://www.twitter.com/goodbyedentsnyc" class="template-icon-social-twitter" target="_blank"></a></li>
					...
					<div class="template-footer-bottom-copyright">
						All Rights Reserved. <a href="#" target="_blank">Goodbye Dentz Inc.</a> &copy; 2016
					</div>
